...
{
    public partial class trialChat : System.Web.UI.Page
    {

        SqlConnection Con = new SqlConnection(@"Data Source=TANISHA;Initial Catalog=hrblock;Integrated Security=True");
        public int currUser = 1010;
