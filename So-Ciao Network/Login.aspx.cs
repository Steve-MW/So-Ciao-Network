...
namespace So_Ciao_Network
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
            {
                ...
                string userName = "";
                string password = "";
                SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-6MA8GF6S\SQLEXPRESS2;Initial Catalog=master;Integrated Security=True");
            ...
            protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string strcon = @"Data Source=LAPTOP-6MA8GF6S\SQLEXPRESS2;Initial Catalog=master;Integrated Security=True";
